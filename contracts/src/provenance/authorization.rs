...
use soroban_sdk::{contract, contractimpl, contracttype, panic_with_error, Address, BytesN, Env, Vec};
...
/// This is a SHA-256 hash of the contract's chain identifier,
/// ensuring tokens cannot be replayed across different provenance chains.
